...
function selectAnnotation(thisDiv) {
    ...
    if (selObj.toString().trim() != "") { //select not vide
        ...
        // modifier range en text 
        var selectAnchorNode = window.getSelection().anchorNode;
        var selectFocusNode = window.getSelection().focusNode;
        var selectAnchorOffset = window.getSelection().anchorOffset;
        var selectFocusOffset = window.getSelection().focusOffset; 
        var range = document.createRange(); 
        range.setStart(selectAnchorNode, selectAnchorOffset );
        range.setEnd(selectFocusNode, selectFocusOffset );
