$(document).ready(function () {
    ...
    $(".dragselection").mousedown(function (event) {
        flag = true;
    ...
    // 鼠标移动时计算遮罩的位置，宽 高
    $(".dragselection").mousemove(function (event) {
    ...
    $(".dragselection").mouseup(function (event) {
    ...
    $(".dragselection").mouseleave(function (event) {
        flag = false;
    ...
    function findSelected() {
        let blockList = $('.dragselection').find('.card-list.document');
        for (let i = 0; i < blockList.length; i++) {
            ...
            if ((leftFlag || rightFlag) && (topFlag || bottomFlag)) {
                ...
                if($(blockList[i]).hasClass('selected')){
